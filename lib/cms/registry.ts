...
export const SECTIONS: Section[] = [
  ...
  /* ---------------- Media ---------------- */
  {
    ...
    kind: "collection",
    icon: "🖼️",
    description: "Student gallery photos. Just paste an image URL and pick a size.",
    titleField: "title",
    fields: [
      { name: "image", label: "Image URL", type: "image", required: true, help: "Paste a Cloudinary / image link. This is what shows in the gallery." },
      { name: "title", label: "Caption", type: "text", help: "Optional — appears on hover and in the lightbox." },
      {
        name: "h",
        label: "Size",
        type: "select",
        half: true,
        options: [
          { value: "tall", label: "Large" },
          { value: "mid", label: "Medium" },
          { value: "short", label: "Small" },
        ],
      },
    ],
