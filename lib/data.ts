...
export type Partner = {
  name: string;
  category: string;
  image?: string; // hero image URL; falls back to a coloured monogram card if empty
  url?: string;
  accent: Accent;
};

export const PARTNERS: Partner[] = [
  { name: "Sunrise Public School", category: "School", accent: "orange", url: "", image: "" },
  { name: "Green Valley Academy", category: "School", accent: "mint", url: "", image: "" },
  { name: "Little Scholars", category: "Institution", accent: "sky", url: "", image: "" },
  { name: "Bright Minds International", category: "Institution", accent: "grape", url: "", image: "" },
  { name: "St. Xavier's Prep", category: "School", accent: "rose", url: "", image: "" },
  { name: "TechKids Foundation", category: "NGO", accent: "sun", url: "", image: "" },
];
